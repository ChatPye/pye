...
type Task = { title: string; instruction: string; evidence: string; timestamp?: number }
  ...
  return (
    <section className="rounded-2xl border border-emerald-400/20 bg-emerald-400/[0.04] p-4">
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        ...
        <button type="button" onClick={() => setShowEvidence((value) => !value)} className="rounded-lg bg-emerald-500 px-3 py-2 text-xs font-medium text-black"><ExternalLink className="mr-1 inline h-3.5 w-3.5" />Add evidence</button>
      </div>
